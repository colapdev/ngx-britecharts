...
export class AppComponent {
  ...
  private filterMultilineChartData(startDate, endDate) {
    ...
    let data = {};
    let that = this;
    data["dataByDate"] = this.multilineChartData["dataByDate"].filter(this.isInRange.bind(null, startDate, endDate));
    data["dataByTopic"] = this.multilineChartData["dataByTopic"].map((topic) => {
        topic.dates = topic.dates.filter(that.isInRange.bind(null, startDate, endDate));
        return topic;
    });
