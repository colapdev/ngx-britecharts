...
var StackedBarChartModule = StackedBarChartModule_1 = (function () {
    function StackedBarChartModule() {
    }
    StackedBarChartModule.forRoot = function () {
        return { ngModule: StackedBarChartModule_1, providers: [] };
    };
    return StackedBarChartModule;
}());
StackedBarChartModule = StackedBarChartModule_1 = __decorate([
    NgModule({
